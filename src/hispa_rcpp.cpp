...
Rcpp::List hispa_analyze_cpp(
    ...
    // try {
        if (verbose) {
            ...
            Rcpp::Rcout << "==============================\n";
            Rcpp::Rcout << "Contact matrix dimensions: " << contact_matrix.n_rows << " x " << contact_matrix.n_cols << "\n";
            Rcpp::Rcout << "Output directory: " << output_dir << "\n\n";
        }
        ...
        my_chromosome.set_contact_matrix(contact_matrix);
        ...
        Rcpp::List result;
        result["positions"] = my_chromosome.get_best_position_matrix();
        result["beta0"] = my_chromosome.get_best_beta0();
        result["beta1"] = my_chromosome.get_best_beta1();
